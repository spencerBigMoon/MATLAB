function [net_power_kw_h, net_power_kw, capped_speed] = calc_new(spd, times, plot_length)
    NUM_PLATES = 1; % PREV 2
    ...
    accel_spd = spd .* WATER_ACC_FACTOR;
    
    % mid
    mid_wet_plt_spd_ms = accel_spd .* ASSUM_MID_WET_PLT_SPD;
